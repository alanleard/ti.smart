...
var teamApi = (function() {
    ...
    for(var i in API){
        if(API[i].url.indexOf("{id}") && API[i].url.indexOf("{alt_id}")){
            // teamApi[API[i].method] = function()...
            alert(i)
        } else if (API[i].url.indexOf("{id}")){
             // teamApi[API[i].method] = function()...
             
        } else {
             // teamApi[API[i].method] = function(params){
                // if(params){
                    // params.url = API[i].url; 
